...
const Upload = (props) => {
    ...
    return (
        <div style={{
            ...
            <Form className="form" content="width=device-width, initial-scale=1" method="POST" action="http://localhost:3001/photos" encType="multipart/form-data" onSubmit={onSubmitHandler}>
